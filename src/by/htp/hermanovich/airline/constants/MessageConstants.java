...
public class MessageConstants {
    ...
    public static final String WRONG_COMMAND = "An invalid command was sent to the controller.";
    ...
    public static final String TICKET_HAS_BEEN_CREATED = "Ticket has been created.";
